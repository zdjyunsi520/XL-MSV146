...
public class MapleCharacter extends AnimatedMapleMapObject implements Serializable, MapleCharacterLook {
    ...
    private int[] remainingHSp = new int[3];
...
//            savedAmount = Integer.parseInt(null);
    ...
    public static MapleCharacter getDefault(final MapleClient client, final JobType type) {
        ...
        ret.map = null;
        ret.exp = 0;
        ret.gmLevel = (byte) client.getAccountGMLevel();
...
//            }
    ...
    public void saveToDB(boolean dc, boolean fromcs) {
        ...
        System.out.println("[saveToDB] Start saving " + name + " (id=" + id + ", dc=" + dc + ", fromcs=" + fromcs + ")");
        Connection con = DatabaseConnection.getConnection();
        ...
        try {
            ...
            ps.close();
            System.out.println("[saveToDB] UPDATE characters OK for " + name);
            ...
            changed_reports = false;
            con.commit();
            System.out.println("[saveToDB] Committed for " + name + " successfully");
        } catch (SQLException | DatabaseException e) {
            FileoutputUtil.outputFileError(FileoutputUtil.PacketEx_Log, e);
...
//            client.getSession().write(InventoryPacket.updateSpecialItemUse(item, type == MapleInventoryType.EQUIPPED ? (byte) 1 : type.getType(), this));
   ...
   //     client.getSession().write(CField.getAndroidTalkStyle(2008, "Yay", 2));
    ...
    public void autoJob() {
        ...
        } else if (GameConstants.isHero(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 111);
                    break;
        ...
        } else if (GameConstants.isPaladin(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 121);
                    break;
        ...
        } else if (GameConstants.isDarkKnight(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 131);
                    break;
        ...
        } else if (GameConstants.isFPMage(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 211);
                    break;
        ...
        } else if (GameConstants.isILMage(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 221);
                    break;
        ...
        } else if (GameConstants.isBishop(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 231);
                    break;
        ...
        } else if (GameConstants.isBowMaster(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 311);
                    break;
        ...
        } else if (GameConstants.isMarksman(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 321);
                    break;
        ...
        } else if (GameConstants.isShadower(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 421);
                    break;
        ...
        } else if (GameConstants.isBuccaneer(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 511);
                    break;
        ...
        } else if (GameConstants.isCorsair(job)) {
            switch (getLevel()) {
                case 60:
                    changeJob((short) 521);
                    break;
        ...
        } else if (GameConstants.isBlazeWizard(job)) {
            switch (getLevel()) {
                case 30:
...
//        client.getSession().write(EffectPacket.updateDeathCount(deathCount));
    ...
    */
    ...
    public void checkZeroWeapon() {
        ...
        int lazuli = lazuliItem == null ? 0 : lazuliItem.getItemId();
        int lapis = lapisItem == null ? 0 : lapisItem.getItemId();
    ...
    public void setSavedAmount(int amount){
        savedAmount = amount;
    }
}
