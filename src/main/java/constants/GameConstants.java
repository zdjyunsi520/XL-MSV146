...
public class GameConstants {
    ...
    public static boolean isBuccaneer(final int job) {
        return (job >= 510 && job <= 512);
    }
    
    public static boolean isCorsair(final int job) {
    ...
    public static boolean isBlazeWizard(final int job) {
        return job == 1200 || (job >= 1210 && job <= 1212);
    }
    ...
    public static boolean isNightWalker(final int job) {
        return job == 1400 || (job >= 1410 && job <= 1412);
    }
    
    public static boolean isThunderBreaker(final int job) {
