...
public class ServerConfig {
    ...
    public static int channelCount = 6;
    ...
    public static int EXP = 6; //exp rate (only works when fixedRates = true)
    public static int MESO = 1; //meso rate (only works when fixedRates = true)
    public static int DROP = 2; //drop rate (only works when fixedRates = true)
