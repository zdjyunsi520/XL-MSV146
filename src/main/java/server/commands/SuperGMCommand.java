    ...
    public static class GiveCash extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            try {
                ...
                c.getPlayer().dropMessage(6, "Invalid amount.");
                return 0;
            }
            MapleCharacter chr = null;
            for (ChannelServer cserv : ChannelServer.getAllInstances()) {
                chr = cserv.getPlayerStorage().getCharacterByName(splitted[1]);
                if (chr != null) {
                    break;
                }
            }
            ...
            chr.modifyCSPoints(4, amount, true);
            chr.saveToDB(false, false);
            c.getPlayer().dropMessage(6, chr.getName() + " cash: NX " + chr.getCSPoints(1) + ", MPoint " + chr.getCSPoints(2) + ", ACash " + chr.getCSPoints(4) + ".");
            return 1;
        }
    }
