...
//        System.setProperty("wzpath", "wz"); // test only..?
        ...
        ServerConfig.EXP = Integer.parseInt(p.getProperty("expRate", String.valueOf(ServerConfig.EXP)));
        ServerConfig.MESO = Integer.parseInt(p.getProperty("mesoRate", String.valueOf(ServerConfig.MESO)));
        ServerConfig.DROP = Integer.parseInt(p.getProperty("dropRate", String.valueOf(ServerConfig.DROP)));
        ServerConfig.channelCount = Integer.parseInt(p.getProperty("channelCount", String.valueOf(ServerConfig.channelCount)));
  ...
  //      MobSkillFactory.getInstance();
        ...
        HttpRegisterServer.start();
        long now = System.currentTimeMillis() - start;
        long seconds = now / 1000;
        long ms = now % 1000;
        System.out.println("Total loading time: " + seconds + "s " + ms + "ms");
        disableRuntimeConsoleOutput();
    }

    private static void disableRuntimeConsoleOutput() {
