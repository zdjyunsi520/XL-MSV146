...
public class ChannelServer {
    ...
    public final void run_startup_configurations() {
        ...
        try {
            ...
            FileoutputUtil.logToFile(FileoutputUtil.SelectCharTrace_Log, "[" + FileoutputUtil.CurrentReadable_Time() + "] channel-bind-success channel=" + channel + " port=" + port + " ip=" + ip + "\r\n");
            eventSM.init();
        } catch (IOException e) {
            instances.remove(channel);
            LoginServer.removeChannel(channel);
            FileoutputUtil.logToFile(FileoutputUtil.SelectCharTrace_Log, "[" + FileoutputUtil.CurrentReadable_Time() + "] channel-bind-failed channel=" + channel + " port=" + port + " ip=" + ip + " " + e.toString() + "\r\n" + FileoutputUtil.getString(e) + "\r\n");
