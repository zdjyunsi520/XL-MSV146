...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendSimple("我可以完全改变你的发型，让你看起来非常棒。要不要换个新发型呢？有了#b#t5150020##k，剩下的交给我吧。选择你喜欢的发型吧！");
    } else if (status == 1) {
	if (selection == 0) {
	    ...
	    cm.askAvatar("我可以完全改变你的发色，让你看起来非常棒。要不要换个新发色呢？有了#b#t5151017##k，剩下的交给我吧。选择你喜欢的颜色吧！", hair_Colo_new);
	} else if (selection == 1) {
