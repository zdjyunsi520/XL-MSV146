...
var ditems;
var dp;
var mitems = Array("200万金币", "#v4080000#Omok", "#v4080001#Omok", "#v4080002#Omok", "#v4080003#Omok", "#v4080004#Omok", "#v4080005#Omok", "#v4080006#Omok", "#v4080007#Omok", "#v4080008#Omok", "#v4080009#Omok", "#v4080010#Omok", "#v4080011#Omok");
...
function start() {
    ...
    if (cm.isGMS()) {
        ...
        nitems = Array("5000点卷", "#v2340000#白卷轴（70级以上）", "#v2049100#混沌卷轴 x 5（70级以上）", "#v5220000#转蛋券 x 25", "#v5050000#AP重置卷 x 5", "#v5050000#AP重置卷 x 26", "#v5062000#奇迹方块 x 4", "#v5062000#奇迹方块 x 21", "#v2022179#黑苹果 x 4", "#v2022179#黑苹果 x 21", "#v5062001#高级奇迹方块 x 2", "#v2530000#幸运日卷轴（70级以上）", "#v2531000#保护卷轴（70级以上）", "#v5211067#1.2倍经验卡（1天）");
        np = Array(2, 2, 10, 4, 2, 2, 10, 2, 10, 2, 10, 18, 10, 20);
        ditems = Array("#v5211068#1.5倍经验卡（1天）", "#v5360000#2倍掉落/金币卡（1天）", "#v4030004#分身（1天，不可交易）", "10000点卷");
        ...
        nitems = Array("5000点卷", "#v5211074#1.2倍经验卡（1天）", "#v2049100#混沌卷轴 x 5（70级以上）", "#v5220000#转蛋券 x 25", "#v5050000#AP重置卷 x 5", "#v5050000#AP重置卷 x 26", "#v5062000#奇迹方块 x 4", "#v5062000#奇迹方块 x 21", "#v2022179#黑苹果 x 4", "#v2022179#黑苹果 x 21", "#v5062001#高级奇迹方块 x 2", "#v2530000#幸运日卷轴（70级以上）", "#v2531000#保护卷轴（70级以上）", "#v5211067#1.2倍经验卡（1天）");
        np = Array(2, 2, 10, 4, 2, 2, 10, 2, 10, 2, 10, 18, 10, 20);
        ditems = Array("#v5211077#1.5倍经验卡（1天）", "#v5360017#2倍掉落/金币卡（1天）", "你好！我是#r#e投票积分NPC#n#k。如果你在我们的网站上投过票，每次都会获得一点积分！我看到你有#e#r", "10000点卷");
        dp = Array(8, 16, 6, 8, 8, 6);
    }
}
...
function action(mode, type, selection) {
    ...
    status++;
    if (status == 0) {
        cm.sendSimple("#n#k投票积分！我可以将你的积分兑换成很酷的东西！你想要什么...？\r\n\r\n#b#L0#兑换普通物品#l\r\n#L1#兑换特殊物品#l\r\n#L2#兑换皇家发型（35投票积分）#l\r\n#L3#兑换小游戏物品#l\r\n#L4#重置全部AP（35投票积分）（不会重置HP或MP）#l#k" + cm.getPlayer().getVPoints() + "#r普通物品？#k嗯，这是我的选择...\r\n\r\n");
    } else if (status == 1) {
        status += selection;
        var selStr;
        var it;
        var ip;
        if (selection == 0) {
            selStr = "#r特殊物品？#k嗯，这些是你在其他地方得不到的物品。这是我的选择...\r\n\r\n";
            it = nitems;
            ip = np;
        } else if (selection == 1) {
            selStr = "选择一个你喜欢的发型。";
            ...
            cm.sendStyle("#r小游戏物品？#k这是我的选择...\r\n\r\n", hairnew);
            return;
        } else if (selection == 3) {
            selStr = "一旦你进行此选择，就不能回头了！你确定要#e重置全部AP吗？（不会重置HP或MP）#k";
            it = mitems;
            ip = mp;
        } else if (selection == 4) {
            cm.sendYesNo("#兑换");
        ...
        for (var i = 0; i < it.length; i++) {
            selStr += "#b#L" + i + "积分来换取 " + ip[i] + "你没有足够的投票积分。你只有 " + it[i] + "#l#k\r\n";
        }
        cm.sendSimple(selStr);
    } else if (status == 2) { //normal item
        if (cm.getPlayer().getVPoints() < np[selection]) {
            cm.sendOk("你的金币太多了。 " + cm.getPlayer().getVPoints());
        } else {
            var passed = false;
            switch(selection) {
                case 0:
