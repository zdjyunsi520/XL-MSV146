...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendSimple("你目前拥有 " + points + " Boss组队任务积分。\r\n\r\n #b#L0#传送到大厅#l  \r\n\r\n#fUI/UIWindow.img/QuestIcon/4/0# \r\n#L2#用竹幸运袋兑换积分(10000)#l\r\n#L3#永恒武器#l\r\n#L4#投掷物#l\r\n#L5#其他#l\r\n#L6#深渊防具#l\r\n#L7#深渊武器#l\r\n#L8#无畏防具#l\r\n#L9#无畏武器#l");
    } else if (status == 1) {
        select = selection;
        switch (selection) {
            case 0:
...
function chooseItem(index) {
    var choice = "从以下物品中选择：#b";
    for (var i = 0; i < items[index].length; i++)
        choice += "\r\n#L" + i + "##i" + items[index][i][0] + "# 兑换 " + items[index][i][1] + " 积分 (#z" + items[index][i][0] + "#)#l";
    choice += "\r\n "
