...
function start() {
	...
	if (cm.isGMS()) {
		...
		nitems = Array("5000点券", "#v2340000#白卷轴（70级以上）", "#v2049100#混沌卷轴x5（70级以上）", "#v5220000#转蛋券x25", "#v5050000#AP重置卷x5", "#v5050000#AP重置卷x26", "#v5062000#奇迹方块x4", "#v5062000#奇迹方块x21", "#v2022179#黑曜石苹果x4", "#v2022179#黑曜石苹果x21", "#v5062001#高级奇迹方块x2", "#v2530000#幸运日卷轴（70级以上）", "#v2531000#保护卷轴（70级以上）", "#v5211067#1.2倍经验卡（1天）");
		np = Array(2, 2, 10, 4, 2, 2, 10, 2, 10, 2, 10, 18, 10, 20);
		ditems = Array("#v5211068#1.5倍经验卡（1天）", "#v5360000#2倍掉落/枫币卡（1天）", "#v4030004#分身（1天，不可交易）", "10000点券");
		...
		nitems = Array("5000点券", "#v5211074#1.2倍经验卡（1天）", "#v2049100#混沌卷轴x5（70级以上）", "#v5220000#转蛋券x25", "#v5050000#AP重置卷x5", "#v5050000#AP重置卷x26", "#v5062000#奇迹方块x4", "#v5062000#奇迹方块x21", "#v2022179#黑曜石苹果x4", "#v2022179#黑曜石苹果x21", "#v5062001#高级奇迹方块x2", "#v2530000#幸运日卷轴（70级以上）", "#v2531000#保护卷轴（70级以上）", "#v5211067#1.2倍经验卡（1天）");
		np = Array(2, 2, 10, 4, 2, 2, 10, 2, 10, 2, 10, 18, 10, 20);
		ditems = Array("#v5211077#1.5倍经验卡（1天）", "#v5360017#2倍掉落/枫币卡（1天）", "你好！我是#r#e投票积分NPC#n#k。如果你在我们的网站上投过票，每次都会获得积分！我看到你有#e#r", "10000点券");
		dp = Array(8, 16, 6, 8, 8, 6);
	}
}
...
function action(mode, type, selection) {
	...
	status++;
	if (status == 0) {
		cm.sendSimple("#n#k投票积分！我可以把你的积分兑换成好东西！你想要什么...？\r\n\r\n#b#L0#兑换普通物品#l\r\n#L1#兑换特殊物品#l\r\n#L2#兑换皇家发型（35投票积分）#l\r\n#L3#兑换小游戏物品#l\r\n#L4#重置全部AP（35投票积分）（不会重置HP或MP）#l#k" + cm.getPlayer().getVPoints() + "#r普通物品？#k好的，这是我的选择...\r\n\r\n");
	} else if (status == 1) {
		status += selection;
		var selStr;
		var it;
		var ip;
		if (selection == 0) {
			selStr = "#r特殊物品？#k好的，这些是你在别处无法获得的物品。这是我的选择...\r\n\r\n";
			it = nitems;
			ip = np;
		} else if (selection == 1) {
			selStr = "选择你喜欢的发型。";
			...
			selStr = "一旦你确认这个选择，就无法撤销！你确定要#e重置你所有的AP吗？（不会重置HP或MP）#k";
			it = mitems;
			ip = mp;
		} else if (selection == 4) {
			cm.sendYesNo("#兑换");
