...
function start(mode, type, selection) {
	...
	if(status == 0) 
		qm.sendYesNo("嘿，婚姻之城玩家，蘑菇王国正处于危险之中！它需要你的帮助，你愿意帮忙吗？");
	if(status == 1)
		qm.sendNext("好的！让我来解释！\r\n事情是这样的，#b蘑菇王国#k目前正处于混乱之中。蘑菇王国位于射手村附近，以热爱和平、聪慧的蘑菇国王而闻名。最近，他开始感到身体不适，所以他决定任命他唯一的女儿#b紫罗兰公主#k。从那以后一定发生了什么事，才导致王国陷入目前的状态。");
	if(status == 2)
